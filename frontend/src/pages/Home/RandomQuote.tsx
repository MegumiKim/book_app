...
const RandomQuote = () => {
  ...
  return (
    <section className="m-auto sm:mt-10 p-4 text-slate-200 max-w-md lg:max-w-3xl xl:max-w-[800px] random-quote-transition">
      <h2 className="text-center text-2xl sm:text-3xl sm:my-4 m-auto font-serif ">
        {quote.quote}
      </h2>
